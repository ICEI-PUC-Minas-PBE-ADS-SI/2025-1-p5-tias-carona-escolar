...
import NextButtonArrow from "../../../components/introduction-animation/NextButtonArrow";
...
const CenterNextButton: React.FC<Props> = ({
  ...
  useEffect(() => {
    ...
    return () => animationController.current.removeAllListeners();
  }, [animationController]);

  const topViewAnim = animationController.current.interpolate({
    inputRange: [0, 0.2, 0.4, 0.6, 0.8, 1],
    outputRange: [96 * 5, 0, 0, 0, 0, 96 * 5],
  });
